...
auth_hrefs = '<li class="nav-item"><a class="nav-link" href="files.html">FILES</a></li><li class="nav-item"><a class="nav-link" href="#">PROFILE</a></li><li class="nav-item"><a class="nav-link" href="#" onclick="logout()">LOGOUT</a></li>'
